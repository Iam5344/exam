...
namespace WinFormsApp16
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            //я в инете посмотрел как сделать. это проверка на то что програма запущена только один раз
            if (!mutex.WaitOne(0))
            {
        ...
        private void SearchDirectory(string folder, string[] bannedWords, string outputFolder, CancellationToken token)
        {
            ...
            //паралельный перебор файлов паралел фор ич делает это автоматически
